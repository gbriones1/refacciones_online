...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Order_Product'
        db.create_table(u'order_order_product', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'order', ['Order_Product'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Order_Product'
        db.delete_table(u'order_order_product')
    ...
    models = {
        u'account.userprofile': {
            ...
            'street1': ('django.db.models.fields.CharField', [], {'max_length': '300', 'null': 'True', 'blank': 'True'}),
            'street2': ('django.db.models.fields.CharField', [], {'max_length': '300', 'null': 'True', 'blank': 'True'}),
        ...
        u'order.order': {
            ...
            'product': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['product.Product']", 'through': u"orm['order.Order_Product']", 'symmetrical': 'False'}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['account.UserProfile']"}),
            'status': ('django.db.models.fields.CharField', [], {'max_length': '3'})
        },
        u'order.order_product': {
            'Meta': {'object_name': 'Order_Product'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
